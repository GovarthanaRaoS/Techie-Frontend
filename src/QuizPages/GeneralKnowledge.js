...
// {currentQuestion>0 && <button className='prevButt' onClick={handlePrevious}>Previous</button>}
// {scoreSheet.length === questions.length && <button className='submitButt' onClick={handleSubmit}>Submit</button>}
// {currentQuestion+1 <questions.length && <button className='nextButt' onClick={handleNext}>Next</button>}